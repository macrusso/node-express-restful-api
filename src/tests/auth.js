      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.error.should.have
            .property("message")
            .eql("User validation failed: password: Path `password` is required., email: Path `email` is required.");
          done();
        });
    });
  });
    ...
    it("it should fail to POST new user", done => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.be.a("object");
          res.body.should.have.property("error");
          res.body.error.should.have.property("message").eql("Sorry, that name and/or email is taken");
          done();
        });
    });
  });
    ...
    it("it should fail to POST login user", done => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.be.a("object");
          res.body.should.have.property("error");
          res.body.error.should.have.property("message").eql("Invalid Email and/or Password");
          done();
        });
    });
  });
